...
--
-- Хост: 127.0.0.1:3307
-- Время создания: Дек 04 2020 г., 13:08
...
--
-- Дамп данных таблицы `clientinfo`
--

INSERT INTO `clientinfo` (`id`, `timeOrder`, `name`, `phone`, `discountCard`, `persons`, `pay`, `money`, `address`, `comment`, `delivery`, `desiredTime`) VALUES
(1, 1607060925, 'Миша', '24236342342', '4234235234232545234', '1', 0, '', 'ffffsddsw', 'dasfaa', 0, '');
...
(34, 'nidzi', 'Нидзи', 305, 'Лосось, икра лосося, огурец, сыр', 'img/nidzi.jpeg', 'imgMini/nidzi.jpeg', '270', 0, 0, 0, 3),
...
(56, 'filadelfiya_s_zapechennym_perc', 'Филадельфия с запеченным перцем', 295, 'Лосось,перец болгарский запеченый, водоросли чукка, сливочный сыр.', 'img/filadelfiya_s_zapechennym_percem.jpeg', 'imgMini/filadelfiya_s_zapechennym_percem.jpeg', '280', 6, 0, 0, 8),
...
(59, 'fukusima', 'Фукусима', 280, 'Семга, огурец, перец обжаренный в сухарях, сливочный сыр, хрустящий лук', 'img/fukusima.jpeg', 'imgMini/fukusima.jpeg', '285', 0, 0, 0, 1),
...
(62, 'shahmaty', 'Шахматы', 275, 'Лосось, огурец, тобико, сыр', 'img/shahmaty.jpeg', 'imgMini/shahmaty.jpeg', '260', 5, 1, 1, 229);
...
--
-- Дамп данных таблицы `ordertomanager`
--

INSERT INTO `ordertomanager` (`idClient`, `idGood`, `count`) VALUES
(1, 62, 1);
...
(5, 'Миша', 'ste@ma.ru', 'stef', 'b0baee9d279d34fa1dfd71aadb908c3f');
