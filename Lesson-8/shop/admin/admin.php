...
<body>
  <div class="operationWrap">
    <button class="btn btn-primary btn_mar" onclick="addNewGood()">Добавить товар</button>
    <button type="button" class="btn btn-primary btn_mar" data-toggle="modal" data-target="#scanDirLoadFiles">
